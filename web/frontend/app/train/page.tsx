...
export default function TrainPage() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h1 className="text-2xl font-bold">Train Models</h1>
        <p className="text-muted-foreground text-sm mt-1">
          Runs <code className="bg-muted px-1 rounded text-xs">02_train_models.py</code> — trains MLP, LSTM, Transformer, and PPO on the uploaded CSV data.
        </p>
      </div>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={chartData} margin={{ top: 4, right: 8, bottom: 4, left: 8 }}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="Original Profit" fill="#4b5563" radius={[3, 3, 0, 0]} />
                  <Bar dataKey="Optimized Profit" fill="#3b82f6" radius={[3, 3, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={160}>
                <BarChart data={chartData.filter((d) => d.MSE != null)} margin={{ top: 4, right: 8, bottom: 4, left: 8 }}>
                  ...
                  <YAxis tick={{ fontSize: 11 }} />
                  <Tooltip />
                  <Bar dataKey="MSE" fill="#f59e0b" radius={[3, 3, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
